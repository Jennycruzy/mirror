...
- Featherless is the default provider for Strategy Patcher and crossover generation; Gemini remains an optional provider when explicitly selected.
...
- The deployed tournament objective is net PnL. Execution controls therefore prioritize reducing repeated loss patterns and locking gains during drawdown while preserving the Kraken CLI audit trail.
