...
class Settings(BaseSettings):
    ...
    tournament_max_same_side_symbol_positions: int = Field(default=1, ge=1)
    ...
    tournament_min_trend_bps: float = Field(default=8.0, ge=0, le=500)
    tournament_trend_lookback_minutes: int = Field(default=20, ge=1, le=1440)
    ...
    tournament_profit_lock_pct: float = Field(default=0.35, ge=0, le=100)
