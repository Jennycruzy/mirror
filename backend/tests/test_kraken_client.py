...
def test_normalize_account_status_extracts_flex_equity_and_positions():
    payload = {
        ...
        "positions": {"openPositions": [{"symbol": "PI_XBTUSD", "side": "short", "size": 310, "price": 1.4, "unrealizedFunding": 0.02}]},
    }
    ...
    assert normalized["positions"]["positions"][0]["entry_price"] == 1.4
    assert normalized["positions"]["positions"][0]["unrealized_pnl"] == 0.02
